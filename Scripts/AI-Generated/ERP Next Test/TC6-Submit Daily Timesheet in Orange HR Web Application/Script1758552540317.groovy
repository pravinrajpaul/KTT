...
"Step 7: Click on button addTimesheet -> Navigate to page '/app/timesheet/new-timesheet-zbpicrvntf'"

WebUI.enhancedClick(findTestObject('AI-Generated/ERP Next Test/Page_app_timesheet/button_addTimesheet_1'))

// WebUI.takeScreenshot(reportLocation + '/TC6/Step 7-Click on button addTimesheet - Navigate to page apptimesheetnew-timesheet-zbpicrvntf.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Submit Daily Timesheet in Orange HR Web Application_visual_checkpoint')
