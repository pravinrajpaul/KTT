...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 2-Click on link projects - Navigate to page appprojects.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 3-Click on div timesheetLink - Navigate to page apptimesheet.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on input checkbox.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Click on link actionOptions delete.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on button confirmYes.png')

"Step 8: Click on link cancel"

WebUI.enhancedClick(findTestObject('AI-Generated/ERP Next Test/Page_app_timesheet/link_cancel'))

// WebUI.takeScreenshot(reportLocation + '/TC8/Step 8-Click on link cancel.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 9-Click on button object.png')

"Step 10: Click on input checkbox"

WebUI.enhancedClick(findTestObject('AI-Generated/ERP Next Test/Page_app_timesheet/input_checkbox'))

// WebUI.takeScreenshot(reportLocation + '/TC8/Step 10-Click on input checkbox.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 11-Click on button actions.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 12-Click on link actionOptions cancel2.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 13-Click on button confirmationYes yes.png')

"Step 14: Click on input checkbox"

WebUI.enhancedClick(findTestObject('AI-Generated/ERP Next Test/Page_app_timesheet/input_checkbox'))

// WebUI.takeScreenshot(reportLocation + '/TC8/Step 14-Click on input checkbox.png')

"Step 15: Click on button actions"

WebUI.enhancedClick(findTestObject('AI-Generated/ERP Next Test/Page_app_timesheet/button_actions'))

// WebUI.takeScreenshot(reportLocation + '/TC8/Step 15-Click on button actions.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 16-Click on link actionOptions delete.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC8/Step 17-Click on button confirmationYes yes2 - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Manage Timesheet Actions in ERP Application_visual_checkpoint')
