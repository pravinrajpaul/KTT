...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 4-Click on button userMenu.png')

"Step 5: Click on button logOut -> Navigate to page '/login'"

WebUI.enhancedClick(findTestObject('AI-Generated/ERP Next Test/Page_app_home/button_logOut'))

// WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on button logOut - Navigate to page login.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify User Logout from Orange HR Web Application_visual_checkpoint')
